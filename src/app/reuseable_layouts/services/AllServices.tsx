    ...
    return <>
        <BABox sx={{ backgroundImage: `url(${service_back.src})` }} className="p-10 md:p-20 bg-center bg-cover">
            <BABox className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <BABox sx={{ backgroundImage: `url(${blind.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white h-full hover:bg-[rgba(0,0,0,.4)] cursor-pointer">
                ...
                <BABox sx={{ backgroundImage: `url(${sofa.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${cutains.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${french_wall.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                        <BAPera className="text-4xl">French Wall</BAPera>
                        <BAPera>Enhance your walls with our elegant French wall designs.</BAPera>
                    </BABox>
                </BABox>
                <BABox sx={{ backgroundImage: `url(${pvc_folding_door.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${wallpaper.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${mediawall.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${puStoneWall.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                ...
                <BABox sx={{ backgroundImage: `url(${Wallpanal.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
                        <BAPera className="text-4xl">Wall Panel</BAPera>
                        <BAPera>Elevate your interiors with our modern and stylish wall panels.</BAPera>
                    </BABox>
                </BABox>
                <BABox sx={{ backgroundImage: `url(${geomatryMoldingWall.src})` }} className="bg-light bg-center bg-cover customRounded shadow-lg my-5">
                    <BABox className="p-10 customRounded hover:text-white hover:bg-[rgba(0,0,0,.4)] cursor-pointer h-full">
